...
A little Jekyll blog using the [Jekyll-Now](https://github.com/barryclark/jekyll-now) repo as a base.

All content is licensed CC BY-NC-SA.

## Credits from Jekyll-Now
